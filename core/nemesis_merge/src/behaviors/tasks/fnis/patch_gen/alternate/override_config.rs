...
pub struct GroupConfig {
    ...
    pub slots: HashMap<u64, SlotConfig>,
}
...
mod num_key_map {
    ...
    pub fn deserialize<'de, D>(deserializer: D) -> Result<HashMap<u64, super::SlotConfig>, D::Error>
    where
        D: Deserializer<'de>,
    {
    ...
    impl<'de> Visitor<'de> for SlotMapVisitor {
        type Value = HashMap<u64, super::SlotConfig>;
