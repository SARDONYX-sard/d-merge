...
struct Config {
    /// Plugin format version written into `HEDR`. Skyrim SE uses `1.7`, LE uses `0.94`.
    version: f32,
...
fn write_dummy_esp(w: &mut impl Write, config: &Config) -> io::Result<()> {
...
///
/// [`BufWriter`]: std::io::BufWriter
pub(super) fn save_dummy_esp<P>(output_dir: P, target: crate::OutPutTarget) -> io::Result<()>
where
    P: AsRef<std::path::Path>,
{
    ...
    let version = match target {
        crate::OutPutTarget::SkyrimSe => 1.7,  // Form 44
        crate::OutPutTarget::SkyrimLe => 0.94, // Form 43
    };
...
mod tests {
    ...
    ///   version = 1.0, author = "SARDONYX", description = "FNIS dummy esp generated by d_merge."
    ///
    ...
    const EXPECTED: &[u8] = &[
        ...
        0x0c, 0x00,                     // size:          12
        0xd7, 0xa3, 0x70, 0x3f,         // version:       1.0f32 LE
