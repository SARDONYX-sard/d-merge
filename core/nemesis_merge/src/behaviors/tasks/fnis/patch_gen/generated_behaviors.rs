...
pub(crate) static CREATURES: phf::Map<&'static str, BehaviorEntry> = phf::phf_map! {
...
pub(crate) static SKELETONS: phf::Map<&'static str, BehaviorEntry> = phf::phf_map! {
    "draugr" => BehaviorEntry {
        behavior_object: "draugr",
        base_dir: "actors/draugr",
        default_behavior: "characterskeleton/draugr_skeleton.bin",
...
pub(crate) static AUXBONES: phf::Map<&'static str, BehaviorEntry> = phf::phf_map! {
    "tail" => BehaviorEntry {
...
pub(crate) static PLANTS_ACTIVATORS: phf::Map<&'static str, BehaviorEntry> = phf::phf_map! {
