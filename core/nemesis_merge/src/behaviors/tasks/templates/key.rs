...
pub(crate) static NEMESIS_3RD_PERSON_MAP: phf::Map<&'static str, &'static str> = phf::phf_map! {
    ...
    "draugr" => "meshes/actors/draugr/characters/draugr.bin", // To Support `Draugr MCO-DXP` Edge case
    "draugr_skeleton" => "meshes/actors/draugr/characterskeleton/draugr_skeleton.bin", // To support `Draugr MCO-DXP` Edge case
