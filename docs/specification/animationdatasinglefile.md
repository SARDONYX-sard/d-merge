# animationdatasinglefile(adsf) Specification
...
```txt
    ...
    436: Characters\ChickenCharater.hkx                        <-- project_asset[1]
    ...
    MainIdle                                                   <-- name: &str
    12                                                         <-- clip_id: &str
    1                                                          <-- play_back_speed: f32
    0                                                          <-- crop_start_local_time: f32
    0                                                          <-- crop_end_local_time: f32
    1                                                          <--  trigger_names_len: usize
    clipEnd:6.65767                                            <--  trigger_name[0]: &str
