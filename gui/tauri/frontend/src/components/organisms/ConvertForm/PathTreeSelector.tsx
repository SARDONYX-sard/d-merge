...
import { useRichTreeViewApiRef, type TreeViewDefaultItemModelProperties, type TreeViewItemId } from '@mui/x-tree-view';
...
export const getAllLeafItemIds = (
  selectedItems: string[],
  items: TreeViewDefaultItemModelProperties[],
): TreeViewItemId[] => {
  const ids: TreeViewItemId[] = [];

  const registerLeafId = (item: TreeViewDefaultItemModelProperties) => {
...
const getItemDescendantsIds = (item: TreeViewDefaultItemModelProperties) => {
  const ids: string[] = [];
...
const getAllItemItemIds = (items: TreeViewDefaultItemModelProperties[]) => {
  const ids: TreeViewItemId[] = [];
...
interface CustomTreeItemProps
  extends Omit<UseTreeItemParameters, 'rootRef'>, Omit<HTMLAttributes<HTMLLIElement>, 'onFocus'> {}
